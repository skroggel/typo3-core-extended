...
class FrontendUserSessionUtility
{
     ...
     *
     * @param \Madj2k\CoreExtended\Domain\Model\FrontendUser $frontendUser
     * @param \Madj2k\CoreExtended\Domain\Model\FrontendUserGroup $frontendUserGroup
     * @return bool
     ...
     * Id of logged-in User
     *
     * @return \Madj2k\CoreExtended\Domain\Model\FrontendUser|null
     * @throws \TYPO3\CMS\Core\Context\Exception\AspectNotFoundException
     */
    public static function getLoggedInUser(): ?FrontendUser
    {
        ...
        if ($uid = self::getLoggedInUserId()) {
            ...
            /** @var \Madj2k\CoreExtended\Domain\Repository\FrontendUserRepository $frontendUserRepository */
