...
use Madj2k\CoreExtended\Domain\Repository\FrontendUserGroupRepository;
...
class FrontendUserSessionUtilityTest extends FunctionalTestCase
{
    ...
    /**
     * @var \Madj2k\CoreExtended\Domain\Repository\FrontendUserRepository|null
     */
    private ?FrontendUserRepository $frontendUserRepository = null;


    /**
     * @var \Madj2k\CoreExtended\Domain\Repository\FrontendUserGroupRepository|null
     */
    ...
    public function simulateLoginReturnsTrueAndCreatesSessionForGivenFrontendUser ()
    {
        ...
        /** @var \Madj2k\CoreExtended\Domain\Model\FrontendUser $frontendUser */
        $frontendUser = $this->frontendUserRepository->findByUid(10);

        /** @var \Madj2k\CoreExtended\Domain\Model\FrontendUserGroup $frontendUserGroup */
    ...
    public function getLoggedInUserWithNormalUserReturnsUserOfRightType ()
    {
         ...
         *
         * Given a persisted frontendUser
         * Given this frontendUser is an instance of \Madj2k\CoreExtended\Domain\Model\FrontendUser
         * Given a persisted userGroup
         * Given simulateLogin has been called with both as parameters before
         * Given simulateLogin has returned true
         * When the method is called
         * Then an instance of \Madj2k\CoreExtended\Domain\Model\FrontendUser is returned
